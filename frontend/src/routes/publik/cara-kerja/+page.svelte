...
<main class="bg-bg">
  <!-- Hero -->
<section class="max-w-[1400px] mx-auto px-8 pt-8 pb-8 text-center">
...
<section class="max-w-[1200px] mx-auto px-8 pb-4">
  ...
  <!-- Kenapa pilih Nitip -->
  <section class="max-w-[1400px] mx-auto px-8 pt-8 pb-16">
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
      {#each benefit as b}
        <div class="bg-white rounded-card p-6 text-center">
  ...
  <section class="max-w-[1200px] mx-auto px-8 pb-16">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
      <div class="bg-white rounded-card p-6">
        <p class="text-xs font-bold text-ink-soft uppercase tracking-wide mb-3">Titip manual</p>
        <ul class="space-y-2 text-sm text-ink/70">
          <li>WA bolak-balik ke banyak orang</li>
          <li>Harga nggak jelas di awal</li>
          <li>Nggak tau posisi barang</li>
        </ul>
      </div>
      <div class="bg-primary rounded-card p-6">
        <p class="text-xs font-bold text-accent uppercase tracking-wide mb-3">Pakai Nitip</p>
        <ul class="space-y-2 text-sm text-white/90">
          <li>Semua obrolan di satu chat</li>
          <li>Harga transparan, bisa nego</li>
          <li>Tracking pesanan jelas</li>
        </ul>
      </div>
    </div>
  </section>
  ...
  <section class="max-w-[1400px] mx-auto px-8 pb-16">
