  ...
  <div class="max-w-[1180px] mx-auto px-5 sm:px-8">
    <div class="bg-ink text-bg rounded-[28px] sm:rounded-[36px] p-6 sm:p-10 md:p-16 grid md:grid-cols-[1.2fr_0.8fr] gap-10 items-center">
      <div>
        ...
        <div class="grid grid-cols-3 gap-3 sm:gap-8 mt-8">
          <div>
            <b class="font-display text-2xl sm:text-3xl text-accent block">1.2rb+</b>
            <span class="text-[11.5px] sm:text-[12.5px] text-bg/70">jastiper aktif</span>
          </div>
          <div>
            <b class="font-display text-2xl sm:text-3xl text-accent block">38</b>
            <span class="text-[11.5px] sm:text-[12.5px] text-bg/70">kota &amp; kabupaten</span>
          </div>
          <div>
            <b class="font-display text-2xl sm:text-3xl text-accent block">4.8/5</b>
            <span class="text-[11.5px] sm:text-[12.5px] text-bg/70">rating rata-rata</span>
          </div>
        </div>
